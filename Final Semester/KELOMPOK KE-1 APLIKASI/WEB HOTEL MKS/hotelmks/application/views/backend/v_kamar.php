...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">HOTEL MKS</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/kamar'?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Rooms</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url().'admin/fasilitas'?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Facility</span></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo site_url('administrator/logout');?>"><i class="si si-logout mr-5"></i><span class="sidebar-mini-hide">Sign Out</span></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Navigation -->
                            ...
                            <div class="block">
                                <div class="block-header block-header-default">
                                    ...
                                    <div class="block-options">
                                        <a href="<?php echo site_url('admin/kamar/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/kamar/get_edit/'.$row->kd_compare);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/kamar/hapus_room'?>" method="post">
